        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          <div className="rounded-lg border border-credential/20 bg-credential/[0.06] p-7 sm:p-9">
            ...
            <p className="mt-5 text-base leading-8 text-slate-300">
              اطلاعات حساب فقط پس از پذیرش در پنل امن شما نمایش داده می‌شود. صاحب
              حساب رسمی پرداخت نسخه ایران مهرداد نادری و بانک مقصد سامان است. اگر
              هر بخشی از درخواست پرداخت با اطلاعات پنل یکسان نیست، پیش از واریز

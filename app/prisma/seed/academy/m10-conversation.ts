...
<p>The exam checks that you know the four qualities of outreach, how to open the conversation with the prospect's challenge, the correct way to handle a price question without approved materials, what a value adding follow up looks like, and where your role ends at handoff. Answer from this material and you will pass.</p>`,
  exercises: [
    {
      ...
      options: ["Long, clever, frequent, and broad", "Personal, honest, specific, and short", "Urgent, vague, repeated, and pushy", "Generic, hyped, scripted, and long"],
      correct: 1,
      explanation: "Good outreach is personal, honest, specific, and short. The other sets describe exactly the blast style to avoid.",
    },
    {
      stem: "A message sent through a mutual contact should lead with what?",
      options: ["A long feature list", "The mutual contact's name and the reason for the introduction", "A price quote", "A promise of results"],
      correct: 1,
    ...
    {
      stem: "When price comes up and you do not have approved current materials to quote from, what do you do?",
      options: ["Quote a number anyway", "Offer a discount", "Point them to the current approved information and the application, and note payment follows acceptance", "Promise a refund if unhappy"],
      correct: 2,
    ...
    {
      stem: "What makes a good follow up message?",
      options: ["Repeating the same ask", "Adding something useful, like an answer or the field story you promised", "Increasing the pressure each time", "Sending many messages quickly"],
      correct: 1,
      explanation: "A good follow up adds value. Repetition, pressure, and rapid blasts are the pest behavior to avoid.",
    },
    {
      stem: "A prospect is clearly not a fit or not interested. What do you do?",
      options: ["Keep chasing until they say yes", "Thank them and move on to the right prospect", "Apply more pressure", "Offer a discount to change their mind"],
      correct: 1,
    ...
    {
      stem: "Which is part of the handoff, where your role ends?",
      options: ["You accept the payment yourself", "You issue the invoice", "The company handles acceptance, payment, and delivery", "You set the final price"],
      correct: 2,
  ...
  exam: [
    {
      stem: "Why must outreach be personal rather than a blast?",
      options: ["Because blasts are faster", "Because a message clearly written to this person earns attention and respects them", "Because personal messages let you promise more", "Because it avoids qualification"],
      correct: 1,
    ...
    {
      stem: "A warm first message to someone you already know should do what?",
      options: ["Open with a long feature pitch", "Remind them who you are, say briefly why you thought of them, and suggest a short conversation", "Quote a price immediately", "Promise a career outcome"],
      correct: 1,
    ...
    {
      stem: "How should the conversation itself open?",
      options: ["With a full pitch of the program", "With a question about the prospect's biggest AI challenge, then listening", "With the price", "With a guarantee"],
      correct: 1,
      explanation: "Open with their challenge and listen. Pitching, pricing, or guaranteeing up front are not how to open.",
    },
    {
      stem: "A prospect asks the price and you have no approved current materials in hand. What is correct?",
      options: ["Make up a number", "Point them to the current approved information and the application, and note payment follows acceptance", "Offer a discount to close", "Promise a result to justify the cost"],
      correct: 1,
    ...
    {
      stem: "Why does pointing to the application instead of pushing payment reduce pressure?",
      options: ["Because it hides the price forever", "Because no one pays before being accepted, so you never sell them into paying first", "Because it removes the review", "Because it lets you promise acceptance"],
      correct: 1,
    ...
    {
      stem: "What distinguishes a professional follow up from being a pest?",
      options: ["Sending more messages, faster", "Adding something useful each time and knowing when to stop", "Increasing pressure with each message", "Repeating the same request"],
      correct: 1,
    ...
    {
      stem: "What is the next step you guide a qualified prospect toward?",
      options: ["Paying you directly", "Applying, which is the first quality gate before any payment", "Signing a contract with you", "Sending you their data"],
      correct: 1,
    ...
    {
      stem: "Which action is outside the partner's role at handoff?",
      options: ["Bringing the right professional to the door", "Registering the opportunity", "Accepting payment and issuing the invoice", "Honestly describing the program"],
      correct: 2,
    ...
    {
      stem: "There is no genuinely cold outreach in this program because of what?",
      options: ["It is simply discouraged", "Strangers from bought or scraped lists are prohibited, so the closest you get is a shared circle led by a real connection", "Cold outreach is allowed but slow", "It requires a fee"],
      correct: 1,
    ...
    {
      stem: "What must every outreach message still satisfy?",
      options: ["Nothing specific", "Approved messaging and the truth test: true, backable, no uncontrollable promises, correct money and data routing", "A minimum length", "A scripted template"],
      correct: 1,
    ...
    {
      stem: "A serious professional responds best when the mini pitch does what?",
      options: ["Maximizes hype", "Leads with the boundary as much as the benefit", "Hides the limits of AI", "Promises a specific result"],
      correct: 1,

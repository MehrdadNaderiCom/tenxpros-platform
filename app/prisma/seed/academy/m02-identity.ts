...
<ul>
  ...
  <li><strong>Strong origination:</strong> a larger or strategically stronger origination that the company classifies and records as strong on the Panel. You do not grade it yourself, and on a B2C deal the strong rate unlocks only after a seat threshold or a Panel Confirmation. The Rules module has the exact unlock and rates.</li>
...
<p>Your exam checks that you can match each function to its meaning, recall the four things a partner protects, identify prohibited claims (certification, income, accreditation, off-channel payment, bought lists, unconfirmed exclusivity), and apply the quick test to tell an approved sentence from a prohibited one.</p>`,
  exercises: [
    ...
    },
    {
      ...
      options: ["Introducing a relevant contact", "A larger or strategically stronger origination that the company classifies as strong on the Panel", "Carrying a deal to a signed agreement", "Coaching a participant after approval"],
      correct: 1,
      explanation: "Strong origination is a larger or strategically stronger origination that the company, not the partner, classifies as strong on the Panel. The others describe introduction, closing, and delivery or coaching.",
    },
    {

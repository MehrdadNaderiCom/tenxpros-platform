...
<ul>
  <li><strong>Basic introduction:</strong> you actively introduce and explain us to someone you genuinely know, then step away: zero meetings and no follow-up. A genuinely valuable introduction is rewarded even though you introduce and step aside. It confers no account ownership or protection.</li>
  ...
  <li><strong>Closing:</strong> you drive the deal to a signed, started contract yourself, taking at most one short online meeting from our side, and carry it through payment, signature, and start.</li>

...
<ul>
  <li><strong>Basic introduction:</strong> you introduce a relevant contact you already have a genuine, warm relationship with.</li>
  <li><strong>Qualified origination:</strong> you open a new department, branch, or unit of a company we already know.</li>
  <li><strong>Strong origination:</strong> you open a company that is genuinely new or dormant to us, on a high-value sale. You never grade this yourself and it is never decided on the Panel by opinion: the company derives it objectively from two recorded facts, whether the company is new and whether the sale is above the high-value threshold. The Rules module has the exact rule and rates.</li>
  <li><strong>Closing:</strong> you carry the opportunity through to a signed, binding agreement, recorded by its signed date.</li>
...
<p>Your exam checks that you can match each function to its meaning, recall the four things a partner protects, identify prohibited claims (certification, income, accreditation, off-channel payment, bought lists, unconfirmed exclusivity), and apply the quick test to tell an approved sentence from a prohibited one.</p>`,
  exercises: [
    ...
    },
    {
      ...
      options: ["Introducing a relevant contact", "Opening a company that is genuinely new or dormant to us on a high-value sale, decided objectively from the recorded facts", "Carrying a deal to a signed agreement", "Coaching a participant after approval"],
      correct: 1,
      explanation: "Strong origination is opening a genuinely new or dormant company on a high-value sale. The company derives it objectively from two recorded facts, the company's newness and the sale amount, not from opinion. The others describe introduction, closing, and delivery or coaching.",
    },
    {
  ...
  exam: [
    ...
    },
    {
      ...
      options: ["Basic introduction means closing a signed agreement", "Closing means introducing a contact", "Qualified origination means opening a new department, branch, or unit of a company we already know", "Delivery means claiming a territory"],
      correct: 2,
      explanation: "Qualified origination is opening a new department, branch, or unit of a company we already know. The other pairings swap the meanings.",
    },
    {

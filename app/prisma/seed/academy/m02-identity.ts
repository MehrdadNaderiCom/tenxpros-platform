...
export const m02: ModuleSeed = {
  ...
  bodyHtml: `<p class="lead">A partner is a trust builder, not a shortcut seller. Keep that one sentence at the center of everything here, because the rest of the module follows from it. This module is about who you are when you speak for a real standard: the role you played, the four things you protect, the lines you must never cross, and the quick test that keeps you safe in the field.</p>

<h2>What you will be able to do</h2>
<ul>
  <li>Name the five partner functions and the origination override, and describe your own role honestly when you register a deal.</li>
...
<ul class="checklist">
  <li>I can name the five functions and the origination override, and register the role I actually performed.</li>
...
<p>Your exam checks that you can match each function to its meaning, recall the four things a partner protects, identify prohibited claims (certification, income, accreditation, off-channel payment, bought lists, unconfirmed exclusivity), and apply the quick test to tell an approved sentence from a prohibited one.</p>`,
  exercises: [
    ...
    {
      stem: "Which of these best describes strong origination?",
      options: ["Introducing a relevant contact", "An origination that reaches the seat threshold, decided objectively from the recorded facts", "Carrying a deal to a signed agreement", "Coaching a participant after approval"],
      correct: 1,
  ...
  exam: [
    ...
    },
    {
      ...
      options: ["Basic introduction means closing a signed agreement", "Closing means introducing a contact", "Qualified origination means going beyond an introduction, attending the meetings and taking on the follow-up", "Delivery means claiming a territory"],
      correct: 2,

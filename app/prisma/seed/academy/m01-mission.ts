...
export const m01: ModuleSeed = {
  ...
  order: 1,
  title: "The Mission",
  summary: "Why TenXPros exists, what separates leading AI adoption from using AI, and the honest posture a partner takes.",
  passMark: 80,
  examSize: 10,
  lesson: [
  ...
  exam: [
    ...
    },
    {
      ...
      correct: 2,
      explanation: "Only this is true and defensible. The others promise certification, promise career outcomes, or route payment improperly.",
    },
    {

...
<ul>
  ...
  <li>List the twelve weekly badges in order and say what a badge actually stands for.</li>
  <li>Name the four phase ranks and what each one means a participant has produced.</li>
...
<table>
  <thead>
    <tr><th>Phase completed</th><th>Rank</th><th>Badge name</th><th>What it means they produced</th></tr>
  </thead>
  <tbody>
    <tr><td>Frame</td><td>TenX Practitioner at Frame Level</td><td>AI Field Analyst</td><td>A documented, defensible use case portfolio and strategy brief</td></tr>
    <tr><td>Design</td><td>TenX Practitioner at Design Level</td><td>AI Systems Builder</td><td>A working AI workflow grounded in domain knowledge with a documented evaluation rubric</td></tr>
    <tr><td>Prove</td><td>TenX Practitioner at Proof Level</td><td>AI Evidence Builder</td><td>A tested, evaluated system with an evidence based value case</td></tr>
    <tr><td>Foresee, with a certified dossier</td><td>TenXPros Certified Professional</td><td>AI Adoption Leader, carrying their field</td><td>A responsible AI adoption system in their domain, built, tested, documented, and defensible</td></tr>
  </tbody>
</table>
...
<p>There is a simple language of progress titles for where a participant is at any moment: accepted member before week one, through the phase ranks, to dossier candidate at submission, and finally to one of the three review outcomes. Use these to set expectations honestly. A participant in week six is a Design level practitioner doing real work, not a certified professional yet, and saying so plainly is part of protecting the standard.</p>
...
<div class="callout callout-success">
  <p><strong>Say this:</strong> The weekly badges mark real work as you go, the four ranks mark real capability, and at the top sits one verifiable, field specific credential reviewed against a public standard.</p>
</div>
...
<table>
  ...
  <tbody>
    <tr><td>Are the badges just gamification?</td><td>No. Each badge is earned by submitting that week's real deliverable, so it is shorthand for work that actually exists.</td></tr>
    ...
    <tr><td>If I finish the weeks, am I certified?</td><td>Not automatically. The flagship rank requires completing Foresee together with a certified dossier, not attendance alone.</td></tr>
...
<ul>
  <li>Two layers: small weekly badges, four phase ranks.</li>
...
<div class="callout callout-warning">
  <p><strong>Mistakes to avoid:</strong> letting the badges sound like the point, implying badges add up to certification, calling the rank or credential an academic qualification, describing it as a generic AI certificate, or rounding a Design level practitioner up to certified professional.</p>
</div>

<h2>Summary checklist</h2>
<ul class="checklist">
  <li>I can explain both recognition layers in thirty seconds.</li>
  <li>I can list the twelve badges in order and say what one stands for.</li>
  <li>I can name each phase rank, its badge name, and what it means they produced.</li>
  <li>I can state the four things that make the flagship credential worth holding.</li>
  <li>I can describe a week six participant honestly as a Design level practitioner.</li>
</ul>
...
<p>Your exam checks that you can order the first weekly badges, pair each phase with its rank and badge name, state what the flagship credential says about its holder, and avoid the two cautions: never sell the badges as the point, and never imply the credential is an academic qualification.</p>`,
  exercises: [
    {

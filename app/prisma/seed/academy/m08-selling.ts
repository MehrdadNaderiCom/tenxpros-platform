...
<p>Expect questions on why you open with the person rather than the program, the three common opening answers, the honest replies to is this just another AI course, is it accredited, do I need to code, and will I definitely get certified, when payment happens, and the four part truth test every sentence must pass.</p>`,
  exercises: [
    {
      ...
      options: ["By describing TenXPros in detail", "By asking about the person's biggest AI challenge in their work, then listening", "By quoting the price", "By promising results"],
      correct: 1,
    ...
    {
      stem: "A prospect says, I have tried some tools but nothing feels systematic. This is best treated as what?",
      options: ["A reason to end the conversation", "A perfect entry point that the program directly addresses", "A signal to promise certification", "An accreditation question"],
      correct: 1,
    ...
    {
      stem: "What is the right length and tone for the mini pitch?",
      options: ["Ten minutes of detail", "Sixty to ninety seconds, no hype", "A single sentence about price", "As long as possible"],
      correct: 1,
      explanation: "The mini pitch is sixty to ninety seconds with no hype. It is not ten minutes, a price line, or open ended.",
    },
    {
      stem: "A prospect asks if the program is accredited. The honest answer is which of these?",
      options: ["Yes, it is a university qualification", "No, it is a private professional certification whose credibility comes from the reviewed dossier and public criteria", "Yes, it is academically accredited", "It is the same as a degree"],
      correct: 1,
    ...
    {
      stem: "When does a prospect pay?",
      options: ["Before applying", "Only after acceptance", "Directly to the partner", "Never"],
      correct: 1,
    ...
    {
      stem: "What is the long game for a partner?",
      options: ["Maximize one off referrals by any means", "Bring in people who belong, tell the truth, and build a reputation as someone who opens doors", "Promise outcomes to close fast", "Sell the badges"],
      correct: 1,
  ...
  exam: [
    {
      stem: "Why open with the person rather than the program?",
      options: ["Because it wastes less of the partner's time", "Because responding to their real situation beats reciting a pitch", "Because it lets the partner avoid the rules", "Because the program is secret"],
      correct: 1,
    ...
    {
      stem: "Which of these is one of the three common opening answers from prospects?",
      options: ["I already lead AI adoption perfectly", "I am worried about falling behind but I am not sure what to do", "I never use AI and never will", "I only want a discount"],
      correct: 1,
    ...
    {
      stem: "What is the purpose of matching a field story to the prospect?",
      options: ["To make the program impressive", "To make the program real in their mind, which beats impressive", "To avoid talking about boundaries", "To promise the example results"],
      correct: 1,
    ...
    {
      stem: "A prospect asks, is this just another AI course. The honest answer is which of these?",
      options: ["Yes, it is the same as other courses", "No, it is built around one real problem and a reviewed dossier, so the outcome is defensible evidence", "Yes, but cheaper", "No, it is an accredited degree"],
      correct: 1,
    ...
    {
      stem: "A prospect asks if they need to code. The correct answer is which of these?",
      options: ["Yes, coding is required", "No, the core requirement is professional judgment, not coding", "Only for engineers", "Coding replaces the dossier"],
      correct: 1,
    ...
    {
      stem: "How should a partner answer, will I definitely get certified?",
      options: ["Yes, everyone certifies", "No, certification depends on whether the dossier meets the standard, and there are three outcomes", "Yes, after attendance", "Only if they pay more"],
      correct: 1,
    ...
    {
      stem: "How can a regulated professional participate safely?",
      options: ["By uploading any confidential data freely", "By protecting confidential data and using redacted or fictionalized examples unless they have rights and safeguards", "By ignoring confidentiality", "They cannot participate at all"],
      correct: 1,
    ...
    {
      stem: "Why does the application before payment structure reduce pressure?",
      options: ["Because the partner can promise acceptance", "Because no one pays before being accepted, so the partner never sells someone into paying first", "Because it hides the price", "Because it removes the review"],
      correct: 1,
    ...
    {
      stem: "What does the acceptance step do for the partner's qualifying job?",
      options: ["Nothing, the partner must still pressure prospects", "It does much of the qualifying, since only genuinely ready people get in", "It guarantees everyone is accepted", "It lets the partner skip honesty"],
      correct: 1,
    ...
    {
      stem: "What is the reputational payoff of selling with integrity?",
      options: ["A long list of one off deals", "Becoming known as someone who opens doors, not someone who sells programs", "Faster closes through promises", "More badges sold"],
      correct: 1,
    ...
    {
      stem: "Every sentence a partner says should pass which test?",
      options: ["Does it sound impressive", "Is it true, can you back it up, does it avoid promising what you cannot control, and does it route money and data correctly", "Does it create urgency", "Does it hide the standard"],
      correct: 1,

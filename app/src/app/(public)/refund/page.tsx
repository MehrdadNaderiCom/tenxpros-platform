...
const sections = [
  ...
  ["Accepted applicants pay to enroll", "Accepted applicants pay through a secure, accepted-applicant payment link. Enrollment is activated and recorded after payment is confirmed."],
  ...
  ["How to request a review", "You can request a refund review by email or support ticket. Acceptance and payment instructions are sent only from hello@tenxpros.com; for questions or help, contact support@tenxpros.com. TenXPros records refund decisions in its payment and audit workflow."],
];
